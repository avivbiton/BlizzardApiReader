...
namespace BlizzardApiReader.Diablo.Models
{
    ...
    public class ProfileHero
    {
        ...
        public PlayerEquippedItems Items { get; set; }
    ...
    {
        public ProfileFollower Templar { get; set; }
        public ProfileFollower Scoundrel { get; set; }
        public ProfileFollower Enchantress { get; set; }
    }
